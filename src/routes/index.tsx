        ...
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
          <div className="order-2 md:order-1">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              <a
                href="#buy"
                className="rounded-full bg-cta-rose px-7 py-4 text-sm font-medium uppercase tracking-widest text-cta-rose-ink shadow-[0_8px_24px_-8px_rgba(225,29,72,0.35)] transition hover:-translate-y-0.5 hover:bg-[#c2185b] hover:shadow-[0_14px_32px_-10px_rgba(225,29,72,0.45)]"
              >
